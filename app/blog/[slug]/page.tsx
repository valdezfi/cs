...
export async function generateStaticParams() {
  const allSlugs = ["affiliatemarketing", "marca", "b2b", "what-is-social-proof", "what-is-a-ugc-creator", "12-popular", "what-is-a-digital-creator", "digitalecommerce-marketing", "famouscreator","find-influencers-for-free","podcast-partnership", "ig", "agencyinfleuncer", "influencer-collaboration", "influencerbrands", "brand-deals-for-influencers-worldwide","lamejor", "macrogrowth", "microvsmacro", "nanoinfluencers", "ugcplatforms", "influence-holiday-campaign","christmas-affiliate-marketing","what-is-influencer-agency","affiliate-marketing-100-day","benefits-drawbacks-influencer-marketing"]; // Add all the blog slugs here
