    ...
    <section className="container mx-auto mt-24 mb-24 px-4 py-16 bg-gray-50 dark:bg-gray-900 transition-colors duration-200 rounded-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl lg:text-5xl text-gray-900 dark:text-white mb-4">billete Blog</h1>
          <p className="mt-6 text-lg text-gray-600 dark:text-gray-300 font-light">
            Learn how to unlock value from your crypto without selling. We cover BTC, ETH, XMR, USDT, USDC, and more.
          </p>
        </div>
        <div className="mt-12">
