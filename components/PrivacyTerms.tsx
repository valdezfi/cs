          ...
          <section className="space-y-8 text-lg leading-relaxed">
            ...
            <div>
              ...
              <p className="mt-2">
                ...
                Co‑Intelligence does not store full payment card details.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2">
                We do <strong>not</strong> sell personal or platform data.
              </p>
            </div>
            ...
            <div className="text-center mt-10">
              <p className="text-lg">
                By using Co‑Intelligence, you agree to this Privacy Policy.
              </p>
            </div>
