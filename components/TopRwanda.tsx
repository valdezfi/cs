...
export default function GrandeRwandaMarketingPage() {
  return (
    <main className="min-h-screen mt-20 bg-white dark:bg-black text-gray-900 dark:text-white">
      <header className="bg-gray-100 dark:bg-zinc-900 py-10 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">
            Grande: The Leading UGC Creator & Influencer Marketing Platform in Rwanda
          </h1>
          <h2 className="text-3xl font-bold text-center text-black dark:text-white mb-8">
            Connect with Rwanda's Top Influencers & UGC Creators
          </h2>
      ...
      <div className="w-full max-w-5xl mx-auto mt-8 mb-12 px-6">
        <Image
          src="/images/rwanda-influencers.jpg"
          alt="Influencer and UGC marketing in Rwanda"
          width={1200}
          height={600}
      ...
      <article className="max-w-4xl mx-auto px-6 space-y-12 pb-20">
        <section>
          <h2 className="text-2xl font-semibold">Looking for a reliable UGC creator platform in Rwanda?</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold">Why Choose Grande for UGC and Influencer Marketing in Rwanda?</h2>
          <ul className="list-disc list-inside space-y-2 mt-4">
            ...
            <li><strong>Diverse Influencer Network:</strong> From micro-influencers to well-known creators across Rwanda, we have a wide range of talent to match your specific needs.</li>
        ...
        <section>
          <h2 className="text-2xl font-semibold">What Makes Grande the Best UGC Creator Platform in Rwanda?</h2>
          <ul className="list-disc list-inside space-y-2 mt-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold">Benefits of Using Grande in Rwanda</h2>
          <ul className="list-disc list-inside space-y-2 mt-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold">Grande: Transforming Marketing with UGC and Influencers in Rwanda</h2>
          <p>
            At Grande, we believe in the power of storytelling through authentic content. By combining our expertise in UGC platform and influencer marketing, we help businesses in Rwanda create impactful campaigns that deliver results.
          </p>
          <ul className="list-disc list-inside space-y-2 mt-4">
            <li>Discover and collaborate with top-tier creators across Rwanda.</li>
        ...
        <section className="text-center">
          <h2 className="text-2xl font-semibold mb-4">Start Your Journey with Grande in Rwanda Today!</h2>
          <p className="mb-6">
            Don’t miss out on the opportunity to elevate your marketing efforts. Partner with Grande, the leading UGC creator platform in Rwanda, and unlock the potential of influencer marketing.
          </p>
          <Link href="/contact">
