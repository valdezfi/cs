...
function SupplyAmountInput({ token, onTokenClick, value, onChange, label }: AmountInputProps) {
  return (
    ...
    <div className="min-h-screen flex items-center justify-center py-12">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 w-full max-w-md flex flex-col space-y-6">
        ...
        <div className="flex items-center space-x-2">
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Calculate Your Supply Interest</h2>
        </div>
        {/* Collateral input */}
        <SupplyAmountInput
          label="Collateral"
