...
import CryptoCard from "./CryptoLoanCard";
    ...
    <section className="container mx-auto mt-12 px-4 py-12 bg-gray-50 dark:bg-gray-900 transition-colors duration-200 rounded-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-gray-900 dark:text-white mb-4">Borrow Now

</h2>
          <p className="mt-8 text-xl text-gray-600 dark:text-gray-300 font-light">
          Use the top 5 coins as collateral. Get crypto loans in BTC, XMR, ETH, USDC (Polygon & Solana), WBTC (Polygon), USDT (Polygon).
